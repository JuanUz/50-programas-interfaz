/*
https://asciinema.org/a/687840

// =========================================
// Programa: Resta de dos números con entrada
// Autor: Garcia Ornelas Juan Carlos.
// Descripción: Solicita dos números al usuario, los resta y muestra el resultado en consola
...
def main():
    ...
    # Restar el segundo número al primer número
    resultado = num1 - num2

    # Mostrar el resultado
    print("Resultado de la resta:", int_to_str(resultado))
...
_start:
        ...
        ldr x1, =buffer             // Dirección del buffer donde está el número en texto
        bl str_to_int               // Llamada a subrutina para convertir a entero en x0
        sub x0, x9, x0              // Restar el segundo número (x0) del primer número (x9)
        ...
        ldr x0, =resultado          // Mensaje de "Resultado de la resta: "
        bl print_str
